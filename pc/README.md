...
기본 가격은 **2026년 9월 조사 기준 참고 시세**입니다. CPU · 그래픽카드 · 메모리 · SSD 주요 품목은
가격비교 사이트 최저가를 확인해 넣었고, 메인보드 · 파워 · 케이스 · 쿨러는 등급 기준 추정치입니다.

2025~2026년 D램 · 낸드 공급 부족으로 **메모리와 저장장치 가격이 예년의 3~5배**입니다.
이 때문에 완성 견적의 하한선이 100만원대로 올라가 있고, 예산 구간과 체급 기준도 여기에 맞춰져 있습니다.
가격 변동이 특히 심한 시기이므로 구매 전 반드시 실제 시세를 다시 확인하세요.

자동 수집된 가격도 쇼핑 검색 결과 기준값이라 실제 구매가와 다를 수 있습니다.
